...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'sib-ui/src/utils/date-util';
  import { hasClass } from 'sib-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'sib-ui/src/utils/util';
