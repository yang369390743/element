...
<script>
import Popper from 'sib-ui/src/utils/vue-popper';
import Clickoutside from 'sib-ui/src/utils/clickoutside';
import Emitter from 'sib-ui/src/mixins/emitter';
import Locale from 'sib-ui/src/mixins/locale';
import Migrating from 'sib-ui/src/mixins/migrating';
import ElInput from 'sib-ui/packages/input';
import ElTag from 'sib-ui/packages/tag';
import ElScrollbar from 'sib-ui/packages/scrollbar';
import ElCascaderPanel from 'sib-ui/packages/cascader-panel';
import AriaUtils from 'sib-ui/src/utils/aria-utils';
import { t } from 'sib-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'sib-ui/src/utils/util';
import { isUndefined, isFunction } from 'sib-ui/src/utils/types';
import { isDef } from 'sib-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'sib-ui/src/utils/resize-event';
